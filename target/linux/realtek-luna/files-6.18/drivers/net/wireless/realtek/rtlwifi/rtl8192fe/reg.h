...
/* Clean-room rtl8192fe register map for the Realtek RTL8192F PCIe 802.11n NIC. */
...
/*-----------------------------------------------------
 *	0x0000h ~ 0x00FFh	System / power configuration
 *-----------------------------------------------------
 */
...
/* LDOHCI 1.2V control (8192-series, shared with 8723/8821 MAC): 1-byte reg */
#define REG_LDOHCI12_CTRL			0x0022
#define REG_LPLDO_CTRL				0x0023
#define REG_AFE_CTRL1				0x0024
#define REG_AFE_XTAL_CTRL			0x0024
#define REG_AFE_CTRL2				0x0028
/* AFE PLL control (alias of REG_AFE_CTRL2 0x0028): hw.c uses +1/+2 byte
 * offsets and 32-bit accesses on the PLL trim/PWR nibble during MAC init.
 */
#define REG_AFE_PLL_CTRL			0x0028
/* LDO switch-regulator control (8192eu/8192F MAC): selects internal LDO vs
 * external SPS during power-on (0xc3 = test-chip, 0x83 = normal-chip).
 */
...
/*-----------------------------------------------------
 *	0x0100h ~ 0x01FFh	Command / FIFO / H2C
 *-----------------------------------------------------
 */
...
/*-----------------------------------------------------
 *	0x0300h ~ 0x03FFh	PCIe (DMA ring bases / BD counts / indices)
 *-----------------------------------------------------
 */
...
/* Read / write pointers (TXBD/RXBD indices) */
...
/* Short alias used by the LLT page-boundary setup in hw.c. */
#define REG_WMAC_LBK_BF_HD			REG_TXPKTBUF_WMAC_LBK_BF_HD
...
/*
 * 8192F type-3 protocol-config quad (programmed 0x06 each in the MAC table).
 * Present only on the 8192F protocol block; absent on the 8192ee part.
 */
#define REG_8192F_PROT_QUAD0			0x2448
#define REG_8192F_PROT_QUAD1			0x244A
#define REG_8192F_PROT_QUAD2			0x244C
#define REG_8192F_PROT_QUAD3			0x244E
...
/* IMR/ISR set-1 (REG_HIMRE / REG_HISRE) bit 0-31 */
...
/*
 * 8192F efuse identity word @0x00. Shared 0x8129 magic with the 8192-series
 * efuse layout; read as a __le16 and compared with le16_to_cpu() on BE.
 */
#define	RTL8192F_EEPROM_ID			0x8129
...
#define	EEPROM_XTAL_92F				0xB9
#define	EEPROM_THERMAL_METER_92F		0xBA
#define	EEPROM_IQK_LCK_92F			0xBB

#define	EEPROM_RF_BOARD_OPTION_92F		0xC1
#define	EEPROM_RF_FEATURE_OPTION_92F		0xC2
#define	EEPROM_RF_BT_SETTING_92F		0xC3
#define	EEPROM_VERSION				0xC4
#define	EEPROM_CUSTOMER_ID			0xC5
#define	EEPROM_RFE_OPTION_92F			0xCA
#define	EEPROM_COUNTRY_CODE_92F			0xCB

#define	EEPROM_KFREE_GAIN_0			0x1EA
#define	EEPROM_KFREE_GAIN_1			0x1EC
#define	EEPROM_KFREE_GAIN_2			0x1EE

#define	EEPROM_MAC_ADDR				0x107
#define EEPROM_VID				0xD6
#define EEPROM_DID				0xD8
#define EEPROM_SVID				0xDA
#define EEPROM_SMID				0xDC

/* _92F-suffixed efuse-offset aliases used by read_eeprom_info()'s params[]
 * table in hw.c, matching the _92F naming convention used elsewhere in this
 * file.  Each aliases the unsuffixed offset above.
 */
#define	EEPROM_CHANNELPLAN_92F			EEPROM_CHANNELPLAN	/* 0xB8 */
#define	EEPROM_VERSION_92F			EEPROM_VERSION		/* 0xC4 */
#define	EEPROM_CUSTOMER_ID_92F			EEPROM_CUSTOMER_ID	/* 0xC5 */
#define	EEPROM_MAC_ADDR_92F			EEPROM_MAC_ADDR		/* 0x107 */
#define	EEPROM_VID_92F				EEPROM_VID		/* 0xD6 */
#define	EEPROM_DID_92F				EEPROM_DID		/* 0xD8 */
#define	EEPROM_SVID_92F				EEPROM_SVID		/* 0xDA */
#define	EEPROM_SMID_92F				EEPROM_SMID		/* 0xDC */

#define	EFUSE_UNDEFINED				0xFF

/* TX pause / queue-stop bits */
...
/* USB shadow registers (unused on the PCIe part, retained for core symmetry) */
...
/* REG_SYS_ISO_CTRL (0x0000) isolation bits */
...
/* REG_SYS_FUNC_EN (0x0002) function-enable bits */
...
/* REG_APS_FSMCO (0x0004) power-sequence-FSM bits */
...
/* REG_RF_CTRL (0x001F) - RF enable / reset / SDM reset */
#define RF_EN					BIT(0)
...
/* REG_MCUFWDL (0x0080) - firmware download control / ready flags */
...
/* REG_PBP (0x0104) page-size select; 8192F programs 0x22 (256-byte pages) */
...
/* REG_RXDMA_CONTROL / queue-stop status bits */
...
/* REG_RQPN (0x0200) / REG_RQPN_NPQ (0x0214) page-quota packers */
...
/* TX-report MAC debug aperture (RPMAC) */
...
/*-----------------------------------------------------
 *	Baseband (BB) register page map 0x800 - 0xFFF
 *-----------------------------------------------------
 */
...
/*
 * 8192F per-rate TX AGC targets. Path-A lives in the 0xE00 block; path-B in
 * the 0x830 block (per PHY_REG_ARRAY_PG). CCK path-A/B share 0x086C.
 */
...
/* IQK / LCK BB aperture (0xE28 - 0xEEC) */
...
/*-----------------------------------------------------
 *	RF-serial register addresses (RTL8192F radio)
 *-----------------------------------------------------
 */
